      ...
      <section className="section experience-section" id="experience">
        ...
        <div className="experience-grid">
          ...
          <article className="experience-card operator-card">
            <div className="experience-copy"><span className="surface-label">Private operator dispatch</span><h3>Control the pool before exposing the work.</h3><p>Only runs matching a mock verified vessel profile appear. Operators can accept an individual posted payout or make a structured counteroffer.</p><ul><li>Availability and eligibility filtering</li><li>Run detail and individual payout</li><li>Five-dollar counteroffer increments</li><li>Assigned runs and offers awaiting selection</li></ul></div>
